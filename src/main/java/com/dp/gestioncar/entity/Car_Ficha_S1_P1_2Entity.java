...
@Entity
@Table(name = "car_ficha_s1_p1_2", schema = "SIGA")
public class Car_Ficha_S1_P1_2Entity implements Serializable {
    
     @EmbeddedId
    private Car_Ficha_S1_P1_2PkEntity car_ficha_s1_p1_2pk;
   ...
   private Integer p1_2_extranjeros;
    ...
    public Car_Ficha_S1_P1_2Entity() {
    }

    public Car_Ficha_S1_P1_2PkEntity getCar_ficha_s1_p1_2pk() {
        return car_ficha_s1_p1_2pk;
    }

    public void setCar_ficha_s1_p1_2pk(Car_Ficha_S1_P1_2PkEntity car_ficha_s1_p1_2pk) {
        this.car_ficha_s1_p1_2pk = car_ficha_s1_p1_2pk;
    }
